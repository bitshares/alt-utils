...
var _FixedDataTableCss = babelHelpers.interopRequireDefault(require("./debug/FixedDataTableCss"));

var _DebugActions = babelHelpers.interopRequireDefault(require("./debug/DebugActions"));

var _DispatcherStore = babelHelpers.interopRequireDefault(require("./debug/DispatcherStore"));
...
var DispatcherDebugger = /*#__PURE__*/function (_React$Component) {
  babelHelpers.inherits(DispatcherDebugger, _React$Component);
  ...
  function DispatcherDebugger() {
    ...
    babelHelpers.classCallCheck(this, DispatcherDebugger);
    _this = _super.call(this);
    _this.getDispatch = _this.getDispatch.bind(babelHelpers.assertThisInitialized(_this));
    _this.renderName = _this.renderName.bind(babelHelpers.assertThisInitialized(_this));
    _this.renderReplay = _this.renderReplay.bind(babelHelpers.assertThisInitialized(_this));
    _this.renderRevert = _this.renderRevert.bind(babelHelpers.assertThisInitialized(_this));
    _this.view = _this.view.bind(babelHelpers.assertThisInitialized(_this));
    return _this;
  }

  babelHelpers.createClass(DispatcherDebugger, [{

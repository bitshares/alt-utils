...
function bind() {
  for (var _len3 = arguments.length, actionIds = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
    actionIds[_key3] = arguments[_key3];
  }

  return function (obj, name, description) {
    return addMeta(description, {
      actions: actionIds
    });
  };
}
...
function datasource() {
  var source = _functions.assign.apply(void 0, arguments);
